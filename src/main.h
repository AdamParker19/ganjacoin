...
static const int LAST_POW_BLOCK = 10300; // Approx. 7.5 Days of Proof-Of-Work
...
static const int64_t MAX_MONEY = 2820000 * COIN; //Does not reflect actual total ganjacoins made.
